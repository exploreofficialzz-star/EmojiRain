                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            // ── Remove Ads promo (if not purchased) ───
                            if (!purchase.adsRemoved) ...[
                              _buildRemoveAdsBanner(context),
                              const SizedBox(height: 12),
                            ],

                            // ── Ad-free status (if purchased) ─────────
                            if (purchase.adsRemoved) ...[
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
              color: AppColors.primary.withOpacity(0.30), width: 1.2),
        ),
        child: const Row(
          children: [
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text('Keep your score + 1 life', style: TextStyle(
