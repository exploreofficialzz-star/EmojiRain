...
/// App-level overlay placed in MaterialApp.builder.
/// Blocks the entire app when ads are detected as blocked.
/// User must either enable ads or purchase Remove Ads to proceed.
class AdBlockerOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Consumer2<AdService, PurchaseService>(
      builder: (_, adService, purchase, __) {
...
class _BlockerScreenState extends State<_BlockerScreen> {
  ...
  Future<void> _retry() async {
    ...
    await AdService.instance.retryAds();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Text(
                      'EmojiRain is free thanks to ads.\n\n'
                      'An ad blocker or DNS filter is active on your device. '
                      'Please disable it to keep playing free, or go ad-free with a purchase.',
                      style: TextStyle(
                            ...
                            : const Row(
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text('Enable Ads & Retry', style: TextStyle(
                                        fontSize: 15, fontWeight: FontWeight.w900,
                                        color: Colors.black, letterSpacing: 0.5,
                                      )),
                                      Text('Disable ad blocker then tap here',
                  ...
                  GestureDetector(
                      ...
                      child: const Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Go Ad-Free', style: TextStyle(
                                fontSize: 15, fontWeight: FontWeight.w900,
                                color: AppColors.primary, letterSpacing: 0.5,
                              )),
                              Text('From \$0.99/day — no ads ever', style: TextStyle(
                    ...
                    delay: 1500.ms, duration: 2000.ms,
